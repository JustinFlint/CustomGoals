...
//Adds placeholders to PlaceholderAPI, using internal class. 
//ECLOUD USE NOT REQUIRED
public class CustomGoalsPAPIExpansion extends PlaceholderExpansion{
	private CustomGoalsHead plugin;
     ...
     */
    public CustomGoalsPAPIExpansion(CustomGoalsHead plugin){
        this.plugin = plugin;
    }
